...
<div class="align-items-baseline d-flex justify-content-between lfr-tooltip-scope my-2">
    ...
    <div class="menu-title">
        <ul class="list-inline mb-0">
            ...
            <li class="list-inline-item">  
                <div class="dropdown"> 
                    <img src="${images_folder}/icons/knowledge-iocn.png" title="Knowledge Portal Links" data-toggle="dropdown" aria-expanded="false" class="header-icon p-2 rounded-circle dropdown-toggle pointer" />   
					<div class="dropdown-menu dropdown-menu-right rounded-0 shadow-lg border-0 p-0"> 
						<@liferay_portlet["runtime"]
                            defaultPreferences="${preferences}"
                            instanceId="knowledge-links"
