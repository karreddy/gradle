...
/**
 * Provides the local service interface for EmployeeDirectory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmployeeDirectoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EmployeeDirectoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.pll.employee.directory.service.impl.EmployeeDirectoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employee directory local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeeDirectoryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<EmployeeDirectory> findEmployeeByDepartmentName(
		String department);
