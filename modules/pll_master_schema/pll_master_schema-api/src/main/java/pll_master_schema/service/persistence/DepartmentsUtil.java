...
public class DepartmentsUtil {
	 ...
	 */
	public static List<Departments> findBylocationId(long locationId) {
	 ...
	 */
	public static List<Departments> findBylocationId(
	...
	public static List<Departments> findBylocationId(
		...
		return getPersistence().findBylocationId(
	...
	public static List<Departments> findBylocationId(
		...
		return getPersistence().findBylocationId(
			locationId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 */
	public static Departments findBylocationId_First(
			long locationId, OrderByComparator<Departments> orderByComparator)
		throws pll_master_schema.exception.NoSuchDepartmentsException {

		return getPersistence().findBylocationId_First(
	 ...
	 */
	public static Departments fetchBylocationId_First(
		long locationId, OrderByComparator<Departments> orderByComparator) {

		return getPersistence().fetchBylocationId_First(
			locationId, orderByComparator);
	}
	 ...
	 * @throws NoSuchDepartmentsException if a matching departments could not be found
	 */
	public static Departments findBylocationId_Last(
			long locationId, OrderByComparator<Departments> orderByComparator)
		throws pll_master_schema.exception.NoSuchDepartmentsException {

		return getPersistence().findBylocationId_Last(
			locationId, orderByComparator);
	}
	 ...
	 */
	public static Departments fetchBylocationId_Last(
		long locationId, OrderByComparator<Departments> orderByComparator) {

		return getPersistence().fetchBylocationId_Last(
			locationId, orderByComparator);
	}
	 ...
	 */
	public static Departments[] findBylocationId_PrevAndNext(
			long departmentId, long locationId,
			OrderByComparator<Departments> orderByComparator)
		throws pll_master_schema.exception.NoSuchDepartmentsException {

		return getPersistence().findBylocationId_PrevAndNext(
			departmentId, locationId, orderByComparator);
	}
