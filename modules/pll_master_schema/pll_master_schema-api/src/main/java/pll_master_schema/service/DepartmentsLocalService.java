...
public interface DepartmentsLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>pll_master_schema.service.impl.DepartmentsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the departments local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DepartmentsLocalServiceUtil} if injection and service tracking are not available.
	 */
