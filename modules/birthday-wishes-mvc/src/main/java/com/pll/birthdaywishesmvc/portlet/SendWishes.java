...
@Component(
		...
		property = {
			...
			"mvc.command.name=/hello/WishesSend"
		},
		service = MVCRenderCommand.class
	)
public class SendWishes implements MVCRenderCommand{
	Log log=LogFactoryUtil.getLog(SendWishes.class);
	

	@Override
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		String fromEmail = "noorarshiya@yopmail.com";
		
		String toMail=renderRequest.getParameter("email");
