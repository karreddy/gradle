...
public class FecthPendingActionMVCResource extends BaseMVCResourceCommand {
		...
		_log.info("Inside action");
		 ...
		 User user = UserLocalServiceUtil.getUser(userId);
		   ...
		   PrintWriter pw = resourceResponse.getWriter();
			 pw.print(pllMasterUtil.fetchActionPendingByUserId(userId));
			 _log.info("Data>>>>>>>>>>>>"+ pllMasterUtil.fetchActionPendingByUserId(userId));
			 pw.flush();
		     pw.close();
