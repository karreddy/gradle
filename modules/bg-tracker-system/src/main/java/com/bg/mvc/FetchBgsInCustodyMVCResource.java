...
@Component(
		...
		property = {
			...
			"mvc.command.name="+ BgTrackerSystemPortletKeys.FETCH_BGS_IN_CUSTODY
		},
		service = MVCResourceCommand.class
	)
public class FetchBgsInCustodyMVCResource extends BaseMVCResourceCommand {
		...
		_log.info("Inside action");
		 ...
		 User user = UserLocalServiceUtil.getUser(userId);
		   ...
		   PrintWriter pw = resourceResponse.getWriter();
			 pw.print(pllMasterUtil.fetchBgsInCustody(userId));
			 _log.info("Data>>>>>>>>>>>>"+ pllMasterUtil.fetchBgsInCustody(userId));
			 pw.flush();
		     pw.close();
