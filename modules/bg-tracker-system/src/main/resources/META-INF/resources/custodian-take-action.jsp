...
<liferay-portlet:resourceURL id="<%= BgTrackerSystemPortletKeys.FETCH_PENDING_ACTIONS%>" var="fetchCustodianPendingAction" copyCurrentRenderParameters="false"/>
...
<table id="yet-to-custodianpendingaction-bg" class="bg-custodianpendingaction-table table" style="width:100%" aria-describedby="cafe-vendor-master-table-info"></table>
</div>
</div>
</div>
</div>
...
$.ajax({
	url: '${fetchCustodianPendingAction}',
	type:'get',
	dataType:'json',
	success: function(data){
		console.log("data : ",data);
		custodianactionPendingDatatable(data, "#yet-to-custodianpendingaction-bg");
	}
});
});
function custodianactionPendingDatatable(data,id){
		      ...
		      [
		    	  {
					...
					
					{
					    ...
					    render: function (data, type, meta) {
                            ...
                            return '<a href="' + actionUrl + '" class="acknowledge-link">Action<i class="bi bi-ui-checks-grid"></i></a>';
