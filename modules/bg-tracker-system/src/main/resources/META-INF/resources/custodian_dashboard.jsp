...
<portlet:renderURL var="bginitiation">
    ...
    <portlet:renderURL var="custodiantakeaction">
    <portlet:param name="jspPage" value="/custodian-take-action.jsp" />
    </portlet:renderURL>
      <portlet:renderURL var="bgscreated">
    <portlet:param name="jspPage" value="/bgs-created.jsp" />
    </portlet:renderURL>
     <portlet:renderURL var="bgsincustody">
    <portlet:param name="jspPage" value="/bgs-custody.jsp" />
    </portlet:renderURL>
...
<div class="bgtracker-db">
	<div class="row">
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="analytics-blocks">
				<a href="${custodiantakeaction}" class="text-decoration-none text-white">
					<div class="analytic-card d-flex justify-content-between">
						<div class="analytic-values">
							<h2>15</h2>
...
<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="analytics-blocks">
				<a href="${bgsincustody}" class="text-decoration-none text-white">
					<div class="analytic-card d-flex justify-content-between">
						<div class="analytic-values">
							<h2>120</h2>
							<h6 class="mb-0 text-white">BGs in Custody</h6>
						</div> 
						<img alt="" src="<%=request.getContextPath()%>/images/sent.png" /> 
					</div> 
				</a> 
